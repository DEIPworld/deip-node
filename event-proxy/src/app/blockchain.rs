...
pub type SubscriptionBufferIn = crate::BufferIn<RuntimeT::Header>;
...
pub type FinalizedBlocksSubscriptionItem =
    Result<Option<RuntimeT::Header>, jsonrpsee_ws_client::Error>;
...
impl BlockchainActorInput {
    ...
    pub fn replay_blocks(
        ...
        head_block: RuntimeT::Hash,
        subscription_buffer: SubscriptionBuffer,
        events_buffer: EventsBuffer,
    ) -> Self {
        Self::Input(BlockchainActorInputData::ReplayBlocks(
            last_known_block,
            head_block,
            subscription_buffer,
            events_buffer,
    ...
    pub fn get_replayed_block_events(hash: RuntimeT::Hash, replay: BlocksReplay) -> Self {
