...
use appchain_deip_runtime::{opaque::Block, AccountId, Balance, BlockNumber, Hash, Index, Moment, AssetId, AssetBalance, AssetExtra, DeipAssetId, TransactionCtxId};
...
where
	...
	C::Api: deip_rpc::DeipStorageRuntimeApi<Block, AccountId, Moment, DeipAssetId, AssetBalance, Hash, TransactionCtxId>,
	...
	BT: BlockT,
{
	...
	io.extend_with(deip_rpc::DeipStorageApi::to_delegate(
		deip_rpc::DeipStorage::new(client, state),
	));
