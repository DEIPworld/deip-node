...
use sp_api_hidden_includes_construct_runtime::hidden_include::traits::PalletInfoAccess;
...
pub struct DeipPalletInfo;

impl frame_support::traits::PalletInfo for DeipPalletInfo {
    fn index<P: 'static>() -> Option<usize> {
      let type_id = TypeId::of::<P>();

      if type_id == TypeId::of::<frame_system::Pallet<Runtime>>() {
            return Some(0)
      }
      if type_id == TypeId::of::<pallet_babe::Pallet<Runtime>>() {
            return Some(1)
      }
      if type_id == TypeId::of::<pallet_timestamp::Pallet<Runtime>>() {
            return Some(2)
      }
      if type_id == TypeId::of::<pallet_authorship::Pallet<Runtime>>() {
            return Some(3)
      }
      if type_id == TypeId::of::<pallet_deip_balances::Pallet<Runtime>>() {
            return Some(4)
      }
      if type_id == TypeId::of::<pallet_transaction_payment::Pallet<Runtime>>() {
            return Some(5)
      }
      if type_id == TypeId::of::<pallet_octopus_appchain::Pallet<Runtime>>() {
            return Some(6)
      }
      if type_id == TypeId::of::<pallet_octopus_lpos::Pallet<Runtime>>() {
            return Some(7)
      }
      if type_id == TypeId::of::<pallet_octopus_upward_messages::Pallet<Runtime>>() {
            return Some(8)
      }
      if type_id == TypeId::of::<pallet_session::Pallet<Runtime>>() {
            return Some(9)
      }
      if type_id == TypeId::of::<pallet_grandpa::Pallet<Runtime>>() {
            return Some(10)
      }
      if type_id == TypeId::of::<pallet_sudo::Pallet<Runtime>>() {
            return Some(11)
      }
      if type_id == TypeId::of::<pallet_im_online::Pallet<Runtime>>() {
            return Some(12)
      }
      if type_id == TypeId::of::<pallet_session_historical::Pallet<Runtime>>() {
            return Some(13)
      }
      if type_id == TypeId::of::<pallet_randomness_collective_flip::Pallet<Runtime>>() {
            return Some(14)
      }
      if type_id == TypeId::of::<pallet_assets::Pallet<Runtime>>() {
            return Some(15)
      }
      if type_id == TypeId::of::<pallet_balances::Pallet<Runtime>>() {
            return Some(16)
      }
      if type_id == TypeId::of::<pallet_uniques::Pallet<Runtime>>() {
            return Some(17)
      }
      if type_id == TypeId::of::<pallet_mmr::Pallet<Runtime>>() {
            return Some(18)
      }
      if type_id == TypeId::of::<pallet_beefy::Pallet<Runtime>>() {
            return Some(19)
      }
      if type_id == TypeId::of::<pallet_beefy_mmr::Pallet<Runtime>>() {
            return Some(20)
      }
      if type_id == TypeId::of::<pallet_multisig::Pallet<Runtime>>() {
            return Some(21)
      }
      if type_id == TypeId::of::<pallet_utility::Pallet<Runtime>>() {
            return Some(22)
      }
      // ^^^^^^^^^^^^^^^^^^^^^^ the trait `pallet_deip::Config` is not implemented for `P`
      // if type_id == TypeId::of::<pallet_deip::Pallet<Runtime>>() {
      //    return Some(23)
      // }
      if type_id == TypeId::of::<pallet_deip_assets::Pallet<Runtime>>() {
            return Some(24)
      }
      if type_id == TypeId::of::<pallet_deip_uniques::Pallet<Runtime>>() {
            return Some(25)
      }
      if type_id == TypeId::of::<pallet_deip_proposal::Pallet<Runtime>>() {
            return Some(26)
      }
      if type_id == TypeId::of::<pallet_deip_dao::Pallet<Runtime>>() {
            return Some(27)
      }
      if type_id == TypeId::of::<pallet_deip_portal::Pallet<Runtime>>() {
            return Some(28)
      }
      if type_id == TypeId::of::<pallet_deip_vesting::Pallet<Runtime>>() {
            return Some(29)
      }
      if type_id == TypeId::of::<pallet_deip_ecosystem_fund::Pallet<Runtime>>() {
            return Some(30)
      }
      if type_id == TypeId::of::<pallet_deip_investment_opportunity::Pallet<Runtime>>() {
            return Some(31)
      } 
      
      return Some(23) // pallet_deip::Pallet
    }
    ...
    fn name<P: 'static>() -> Option<&'static str> {
      ...
      if type_id == TypeId::of::<pallet_deip_balances::Pallet<Runtime>>() {
            return Some("DeipBalances")
      }
      if type_id == TypeId::of::<pallet_transaction_payment::Pallet<Runtime>>() {
            return Some("TransactionPayment")
      }
      if type_id == TypeId::of::<pallet_octopus_appchain::Pallet<Runtime>>() {
            return Some("OctopusAppchain")
      }
      if type_id == TypeId::of::<pallet_octopus_lpos::Pallet<Runtime>>() {
            return Some("OctopusLpos")
      }
      if type_id == TypeId::of::<pallet_octopus_upward_messages::Pallet<Runtime>>() {
            return Some("OctopusUpwardMessages")
      }
      if type_id == TypeId::of::<pallet_session::Pallet<Runtime>>() {
            return Some("Session")
      }
      ...
      if type_id == TypeId::of::<pallet_assets::Pallet<Runtime>>() {
            return Some("ParityTechAssets")
      }
      if type_id == TypeId::of::<pallet_balances::Pallet<Runtime>>() {
            return Some("Balances")
      }
      if type_id == TypeId::of::<pallet_uniques::Pallet<Runtime>>() {
            return Some("ParityTechUniques")
      }
      if type_id == TypeId::of::<pallet_mmr::Pallet<Runtime>>() {
            return Some("Mmr")
      }
      ...
      // ^^^^^^^^^^^^^^^^^^^^^^ the trait `pallet_deip::Config` is not implemented for `P`
      // if type_id == TypeId::of::<pallet_deip::Pallet<P>>() {
      //    return Some("Deip")
      // }
      if type_id == TypeId::of::<pallet_deip_assets::Pallet<Runtime>>() {
            return Some("Assets")
      ...
      if type_id == TypeId::of::<pallet_deip_proposal::Pallet<Runtime>>() {
            return Some("DeipProposal")
      }
      if type_id == TypeId::of::<pallet_deip_dao::Pallet<Runtime>>() {
            return Some("DeipDao")
      }
      if type_id == TypeId::of::<pallet_deip_portal::Pallet<Runtime>>() {
            return Some("DeipPortal")
      }
      if type_id == TypeId::of::<pallet_deip_vesting::Pallet<Runtime>>() {
            return Some("DeipVesting")
      }
      if type_id == TypeId::of::<pallet_deip_ecosystem_fund::Pallet<Runtime>>() {
            return Some("DeipEcosystemFund")
      }
      if type_id == TypeId::of::<pallet_deip_investment_opportunity::Pallet<Runtime>>() {
            return Some("DeipInvestmentOpportunity")
      }

      return Some("Deip") // pallet_deip::Pallet
    }
    ...
    fn module_name<P: 'static>() -> Option<&'static str> {
      ...
      if type_id == TypeId::of::<pallet_deip_balances::Pallet<Runtime>>() {
            return Some("pallet_deip_balances")
      }
      if type_id == TypeId::of::<pallet_transaction_payment::Pallet<Runtime>>() {
            return Some("pallet_transaction_payment")
      }
      if type_id == TypeId::of::<pallet_octopus_appchain::Pallet<Runtime>>() {
            return Some("pallet_octopus_appchain")
      }
      if type_id == TypeId::of::<pallet_octopus_lpos::Pallet<Runtime>>() {
            return Some("pallet_octopus_lpos")
      }
      if type_id == TypeId::of::<pallet_octopus_upward_messages::Pallet<Runtime>>() {
            return Some("pallet_octopus_upward_messages")
      }
      if type_id == TypeId::of::<pallet_session::Pallet<Runtime>>() {
      ...
      if type_id == TypeId::of::<pallet_beefy::Pallet<Runtime>>() {
            return Some("pallet_beefy")
      }
      if type_id == TypeId::of::<pallet_beefy_mmr::Pallet<Runtime>>() {
            return Some("pallet_beefy_mmr")
      }
      if type_id == TypeId::of::<pallet_multisig::Pallet<Runtime>>() {
      ...
      // ^^^^^^^^^^^^^^^^^^^^^^ the trait `pallet_deip::Config` is not implemented for `P`
      // if type_id == TypeId::of::<pallet_deip::Pallet<P>>() {
      //    return Some("pallet_deip")
      // }
      if type_id == TypeId::of::<pallet_deip_assets::Pallet<Runtime>>() {
            return Some("pallet_deip_assets")
      }
      if type_id == TypeId::of::<pallet_deip_uniques::Pallet<Runtime>>() {
            return Some("pallet_deip_uniques")
      }
      if type_id == TypeId::of::<pallet_deip_proposal::Pallet<Runtime>>() {
            return Some("pallet_deip_proposal")
      }
      if type_id == TypeId::of::<pallet_deip_dao::Pallet<Runtime>>() {
            return Some("pallet_deip_dao")
      }
      if type_id == TypeId::of::<pallet_deip_portal::Pallet<Runtime>>() {
            return Some("pallet_deip_portal")
      }
      if type_id == TypeId::of::<pallet_deip_vesting::Pallet<Runtime>>() {
            return Some("pallet_deip_vesting")
      }
      if type_id == TypeId::of::<pallet_deip_ecosystem_fund::Pallet<Runtime>>() {
            return Some("pallet_deip_ecosystem_fund")
      }
      if type_id == TypeId::of::<pallet_deip_investment_opportunity::Pallet<Runtime>>() {
            return Some("pallet_deip_investment_opportunity")
      }

      return Some("pallet_deip") // pallet_deip::Pallet

    }

        /// Convert the given pallet `P` into its containing crate version.
        fn crate_version<P: 'static>() -> Option<CrateVersion> {
            // Some(CrateVersion::new(3, 0, 0))

        let type_id = TypeId::of::<P>();

        if type_id == TypeId::of::<frame_system::Pallet<Runtime>>() {
          return Some(frame_system::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_babe::Pallet<Runtime>>() {
        ...
        if type_id == TypeId::of::<pallet_authorship::Pallet<Runtime>>() {
          return Some(pallet_authorship::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_balances::Pallet<Runtime>>() {
          return Some(pallet_deip_balances::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_transaction_payment::Pallet<Runtime>>() {
          return Some(pallet_transaction_payment::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_octopus_appchain::Pallet<Runtime>>() {
          return Some(pallet_octopus_appchain::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_octopus_lpos::Pallet<Runtime>>() {
          return Some(pallet_octopus_lpos::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_octopus_upward_messages::Pallet<Runtime>>() {
          return Some(pallet_octopus_upward_messages::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_session::Pallet<Runtime>>() {
          return Some(pallet_session::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_grandpa::Pallet<Runtime>>() {
          return Some(pallet_grandpa::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_sudo::Pallet<Runtime>>() {
          return Some(pallet_sudo::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_im_online::Pallet<Runtime>>() {
          return Some(pallet_im_online::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_session_historical::Pallet<Runtime>>() {
          return Some(pallet_session_historical::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_randomness_collective_flip::Pallet<Runtime>>() {
          return Some(pallet_randomness_collective_flip::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_assets::Pallet<Runtime>>() {
          return Some(pallet_assets::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_balances::Pallet<Runtime>>() {
          return Some(pallet_balances::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_uniques::Pallet<Runtime>>() {
          return Some(pallet_uniques::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_mmr::Pallet<Runtime>>() {
          return Some(pallet_mmr::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_beefy::Pallet<Runtime>>() {
          return Some(pallet_beefy::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_beefy_mmr::Pallet<Runtime>>() {
          return Some(pallet_beefy_mmr::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_multisig::Pallet<Runtime>>() {
          return Some(pallet_multisig::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_utility::Pallet<Runtime>>() {
          return Some(pallet_utility::Pallet::<Runtime>::crate_version())
        }
        // ^^^^^^^^^^^^^^^^^^^^^^ the trait `pallet_deip::Config` is not implemented for `P`
        // if type_id == TypeId::of::<pallet_deip::Pallet<P>>() {
        //  return Some(23)
        // }
        if type_id == TypeId::of::<pallet_deip_assets::Pallet<Runtime>>() {
          return Some(pallet_deip_assets::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_uniques::Pallet<Runtime>>() {
          return Some(pallet_deip_uniques::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_proposal::Pallet<Runtime>>() {
          return Some(pallet_deip_proposal::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_dao::Pallet<Runtime>>() {
          return Some(pallet_deip_dao::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_portal::Pallet<Runtime>>() {
          return Some(pallet_deip_portal::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_vesting::Pallet<Runtime>>() {
          return Some(pallet_deip_vesting::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_ecosystem_fund::Pallet<Runtime>>() {
          return Some(pallet_deip_ecosystem_fund::Pallet::<Runtime>::crate_version())
        }
        if type_id == TypeId::of::<pallet_deip_investment_opportunity::Pallet<Runtime>>() {
          return Some(pallet_deip_investment_opportunity::Pallet::<Runtime>::crate_version())
        } 
        
        return Some(pallet_deip::Pallet::<Runtime>::crate_version()) // pallet_deip::Pallet
...
impl frame_system::Config for Runtime {
    ...
    type PalletInfo = DeipPalletInfo;
...
construct_runtime!(
            ...
            UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        DeipBalances: pallet_deip_balances,
